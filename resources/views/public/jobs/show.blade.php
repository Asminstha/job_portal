        ...
        <div class="w-full lg:w-80 flex-shrink-0">
            <div class="sticky top-24 space-y-5">
                ...
                <div class="card p-6">
                    @if($hasApplied)
                        ...
                        <div class="text-center">
                            <div class="w-14 h-14 bg-green-100 dark:bg-green-900/40 rounded-full
                                        flex items-center justify-center mx-auto mb-3">
                                <svg class="w-7 h-7 text-green-600 dark:text-green-400"
                ...
                <div class="card p-6">
                    ...
                    <div class="space-y-3">
                        @foreach([
                            ['label' => 'Posted',      'value' => optional($job->published_at ?? $job->created_at)->format('M d, Y')],
                            ['label' => 'Deadline',    'value' => $job->expires_at?->format('M d, Y') ?? 'Open until filled'],
                            ['label' => 'Job Type',    'value' => $job->typeLabel()],
                            ['label' => 'Work Mode',   'value' => ucfirst($job->location_type)],
                            ['label' => 'Location',    'value' => $job->city ? $job->city.', '.$job->country : $job->country],
                            ['label' => 'Salary',      'value' => $job->salaryDisplay()],
                            ['label' => 'Experience',  'value' => $job->experience_min.'+ years'],
                        ] as $item)
