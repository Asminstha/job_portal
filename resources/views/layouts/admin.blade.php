...
<body class="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        {{-- ── Sidebar ──────────────────────────────────────── --}}
        <aside
            class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 dark:bg-gray-950
                ...
                <a href="{{ route('admin.jobs.index') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium
                      ...
                      {{ request()->routeIs('admin.jobs.*')
                          ...
                          : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2
          ...
          {{ request()->routeIs('admin.categories.*')
                ...
                <a href="{{ route('admin.subscriptions.index') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium
                      ...
                      {{ request()->routeIs('admin.subscriptions.*')
                          ...
                          : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0
            ...
            <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-800 bg-gray-900 dark:bg-gray-950">
                <div class="flex items-center gap-3">
                    <div
                        class="w-8 h-8 rounded-full bg-red-900 flex items-center justify-center
        ...
        {{-- Mobile overlay --}}
        <div x-show="sidebarOpen" @click="sidebarOpen = false" class="fixed inset-0 z-40 bg-black/60 lg:hidden">
        </div>
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            {{-- Top bar --}}
            <header
                class="h-16 bg-white dark:bg-gray-900
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('home') }}" target="_blank" class="btn-secondary text-sm">
                        View Site
                    </a>
                </div>
            </header>
