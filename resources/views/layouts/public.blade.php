    ...
    <div x-show="mobileMenu"
        ...
        <a href="{{ route('jobs.index') }}"
           class="block px-3 py-2 rounded-lg text-sm font-medium
                  text-gray-700 dark:text-gray-300
                  hover:bg-gray-100 dark:hover:bg-gray-800">Browse Jobs</a>
        <a href="{{ route('companies.index') }}"
           class="block px-3 py-2 rounded-lg text-sm font-medium
                  text-gray-700 dark:text-gray-300
...
<footer class="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 mt-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <li><a href="{{ route('companies.index') }}" class="hover:text-brand-600 transition-colors">Companies</a></li>
                </ul>
            </div>
            <div>
        ...
        <div class="border-t border-gray-200 dark:border-gray-800 pt-6 flex flex-col sm:flex-row
